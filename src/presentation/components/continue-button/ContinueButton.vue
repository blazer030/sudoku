<template>
    <button
        v-if="showContinue"
        class="flex items-center justify-center gap-2.5 h-14 w-full bg-primary rounded-2xl text-white shadow-primary cursor-pointer transition-all duration-200 hover:bg-primary-hover hover:shadow-primary-lg"
